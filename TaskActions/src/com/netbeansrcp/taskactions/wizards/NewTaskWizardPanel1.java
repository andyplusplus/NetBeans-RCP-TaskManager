...
public class NewTaskWizardPanel1 implements WizardDescriptor.Panel {
	...
	String txt = "You want a Task without parent" + " Create Task...";
	if (null != parentId) {
	    txt = "You want to create a Subtask for the task with the ID..." + parentId;
	}
	
	((NewTaskVisualPanel1) this.getComponent()).getInfoLabel().setText(txt);
    }//public
