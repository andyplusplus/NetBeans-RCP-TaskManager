...
final class PreferencesPanel extends javax.swing.JPanel {
	...
	this.jTextField1.setText(
		Lookup.getDefault().lookup(Preferences.class).
		getPersistencePath().getAbsolutePath()     );
	...
	Lookup.getDefault().lookup(Preferences.class).
		setPersistencePath(this.jTextField1.getText());
    }

    boolean valid() {
	return new File(this.jTextField1.getText()).isDirectory();
    }
