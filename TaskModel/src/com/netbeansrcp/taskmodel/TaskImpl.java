...
//        this.id = "" + System.currentTimeMillis();
        ...
        this.name = name;
	if (this.name.equals("")){
	    this.name = NbBundle.getMessage(TaskImpl.class, "CTL_DefaultTaskName") + this.id;
	}
	...
	this.pss.firePropertyChange(PROP_CHILDREN_MODIFICATION, evt.getOldValue(),evt.getNewValue());
    }
